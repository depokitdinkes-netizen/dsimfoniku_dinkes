...
$(document).ready(function() {
    ...
    const { kecamatan: kecamatanData, kelurahan: kelurahanData } = window.pasarInternalEditData || {};
    
    let kecVal = kecamatanData || "";
    let kelVal = kelurahanData || "";
...
document.addEventListener('DOMContentLoaded', function() {
    // Add any additional initialization code for pasar-internal edit form here
});