/**
 * JavaScript for Akomodasi Edit Page
 * Handles district/village population and SLS date calculation functionality
 */
...
$(document).ready(function() {
    ...
    let kecVal = window.akomodasiEditData ? window.akomodasiEditData.kecamatan : '';
    let kelVal = window.akomodasiEditData ? window.akomodasiEditData.kelurahan : '';
