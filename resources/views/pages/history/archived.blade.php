...
<div data-window-var="baseUrl" data-value="{{ url('/') }}" style="display:none;"></div>
<div data-window-var="csrfToken" data-value="{{ csrf_token() }}" style="display:none;"></div>
<script src="{{ asset('js/history/archived.js') }}"></script>
@endsection
