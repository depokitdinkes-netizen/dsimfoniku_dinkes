...
<div data-window-var="tempatOlahragaFormData" data-kecamatan="{{ $form_data['kecamatan'] ?? '' }}" data-kelurahan="{{ $form_data['kelurahan'] ?? '' }}" style="display:none;"></div>
<script src="{{ asset('js/inspection/tempat-olahraga/edit.js') }}"></script>
