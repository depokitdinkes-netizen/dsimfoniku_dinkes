...
@section('content')
<x-section.page-header title="Inspeksi / Penilaian Gelanggang Olahraga" />

<x-breadcrumb.create-inspection />

<form action="{{ route('tempat-olahraga.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('POST')
    <!-- INFORMASI UMUM -->
...
<script src="{{ asset('js/inspection/tempat-olahraga/create.js') }}"></script>
