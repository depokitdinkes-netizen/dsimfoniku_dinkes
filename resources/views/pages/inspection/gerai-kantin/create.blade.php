...
@section('content')
<x-section.page-header title="Inspeksi / Penilaian Gerai Kantin {{ $kantin['subjek'] }}" />
...
<div class="px-3 sm:px-6 py-3">
    <div class="breadcrumbs text-sm">
        <ul>
            ...
            <li>Penilaian / Inspeksi Gerai</li>
        </ul>
    </div>
</div>

<form action="{{ route('gerai-kantin.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('POST')
    <!-- INFORMASI UMUM -->
        ...
        <div class="bg-white p-6 sm:p-8 rounded-xl">
            ...
            <div class="grid grid-flow-row md:grid-cols-2 gap-5">
                ...
                <div class="input-group">
                    ...
                    <select name="{{ $form_input['name'] }}" id="kec" class="select select-bordered" disabled>
                ...
                <div class="input-group">
                    ...
                    <select name="{{ $form_input['name'] }}" id="kel" class="select select-bordered" disabled>
...
<div data-window-var="geraiKantinCreateData" data-kecamatan="{{ $kantin['kecamatan'] }}" data-kelurahan="{{ $kantin['kelurahan'] }}" style="display:none;"></div>

<script src="{{ asset('js/getDistrictsAndVillages.js') }}"></script>
<script src="{{ asset('js/autosave-form.js') }}"></script>
<script src="{{ asset('js/inspection/gerai-kantin/create.js') }}"></script>
@endsection
