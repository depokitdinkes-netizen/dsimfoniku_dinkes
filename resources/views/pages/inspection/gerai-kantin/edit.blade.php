...
<script>
    $(document).ready(function() {
        // Data untuk kantin (read-only)
        let kecKantinVal = "{{ $kantin['kecamatan'] }}";
        let kelKantinVal = "{{ $kantin['kelurahan'] }}";
        
        // Data untuk gerai kantin (editable)
        let kecGeraiVal = "{{ $form_data['kecamatan'] }}";
        let kelGeraiVal = "{{ $form_data['kelurahan'] }}";
