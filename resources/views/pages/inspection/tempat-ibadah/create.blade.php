...
@section('content')
<x-section.page-header title="Inspeksi / Penilaian Tempat Ibadah" />
        ...
        <div class="bg-white flex-grow pb-4 rounded-xl">
            ...
            <div class="px-3 sm:px-8">
                <label for="{{ $form_input['name'] }}" class="flex flex-wrap lg:flex-nowrap gap-2 p-4 border rounded mb-3 font-medium items-center cursor-pointer">
                    ...
                    <input type="checkbox" name="{{ $form_input['name'] }}" id="{{ $form_input['name'] }}" class="checkbox checkbox-primary rounded-sm ml-auto" value="{{ $form_input['score'] }}" />
                </label>
            </div>
            @break
