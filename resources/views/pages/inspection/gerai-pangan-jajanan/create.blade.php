...
@section('content')
<x-section.page-header title="Inspeksi / Penilaian Gerai Pangan Jajanan" />

<x-breadcrumb.create-inspection />

<form action="{{ route('gerai-pangan-jajanan.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('POST')
    <!-- INFORMASI UMUM -->
