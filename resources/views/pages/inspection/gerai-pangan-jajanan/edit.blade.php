...
@section('content')
<x-section.page-header title="Ubah Informasi / Penilaian Gerai Pangan Jajanan" />

<x-breadcrumb.edit-inspection showRoute="{{ route('gerai-pangan-jajanan.show', ['gerai_pangan_jajanan' => $form_data['id']]) }}" />


<form action="{{ route('gerai-pangan-jajanan.update', ['gerai_pangan_jajanan' => $form_data['id']]) }}" method="POST">
    @csrf
    @method('PUT')
    <!-- INFORMASI UMUM -->
            ...
            <div class="grid grid-flow-row md:grid-cols-2 gap-5">
                ...
                <div class="input-group">
                    ...
                    <select name="{{ $form_input['name'] }}" id="kec" class="select select-bordered" required>
                        ...
                        @if(isset($form_data['kecamatan']) && $form_data['kecamatan'])
                ...
                <div class="input-group">
                    ...
                    <select name="{{ $form_input['name'] }}" id="kel" class="select select-bordered" required>
                        ...
                        @if(isset($form_data['kelurahan']) && $form_data['kelurahan'])
...
<div data-window-var="geraiPanganJajananEditData" data-kecamatan="{{ $form_data['kecamatan'] ?? '' }}" data-kelurahan="{{ $form_data['kelurahan'] ?? '' }}" style="display:none;"></div>
...
<script src="{{ asset('js/inspection/gerai-pangan-jajanan/edit.js') }}"></script>
@endsection
