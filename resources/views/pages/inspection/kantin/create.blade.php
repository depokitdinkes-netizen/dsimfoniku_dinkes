...
@section('content')
<x-section.page-header title="Inspeksi / Penilaian Sentra Kantin" />

<x-breadcrumb.create-inspection />

<form action="{{ route('kantin.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('POST')
    <!-- INFORMASI UMUM -->
    ...
    <div class="px-3 pb-3 sm:px-6 sm:pb-6">
        <div class="bg-primary/10 p-6 sm:p-8 rounded-xl">
            <p class="font-medium text-primary">Info : Penilaian <span class="font-bold">Gerai Kantin</span> dapat diakses setelah submit form penilaian <span class="font-bold">Sentra Kantin</span> ini</p>
        </div>
    </div>
...
<script src="{{ asset('js/inspection/kantin/create.js') }}"></script>
