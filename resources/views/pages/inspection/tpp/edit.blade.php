...
<div class="p-6 border-b flex items-center justify-between gap-5">
    <h1 class="font-extrabold text-xl">Ubah Informasi / Penilaian Tempat Pengolahan Pahan</h1>
...
<div class="px-6 py-3">
    <div class="breadcrumbs text-sm">
        <ul>
            ...
            <li><a class="text-blue-500" href="{{ route('tpp-tertentu.show', ['tpp_tertentu' => $form_data['id']]) }}">Hasil Inspeksi</a></li>
            <li>Ubah Data Formulir</li>
        </ul>
    </div>
</div>

<form action="{{ route('tpp-tertentu.update', ['tpp_tertentu' => $form_data['id']]) }}" method="POST">
    @csrf
    @method('PUT')
    <!-- INFORMASI UMUM -->
    <div class="px-6 pb-6">
    ...
    <div class="px-6 pb-6 flex gap-5">
        ...
        @endif">
            ...
            <div class="px-6 sm:px-8">
                <div class="input-group">
                    <textarea name="catatan-lain" id="catatan-lain" class="resize-none h-52" placeholder="Catatan mengenai hasil inpeksi lingkungan kesehatan...">{{ $form_data['catatan-lain'] }}</textarea>
                </div>
            </div>
            ...
            <div class="px-6 sm:px-8">
                <div class="input-group">
                    <textarea name="rencana-tindak-lanjut" id="rencana-tindak-lanjut" class="resize-none h-52" placeholder="Rencana untuk tindak lanjut kedepannya setelah inpeksi lingkungan kesehatan...">{{ $form_data['rencana-tindak-lanjut'] }}</textarea>
                </div>
            </div>
        </div>
