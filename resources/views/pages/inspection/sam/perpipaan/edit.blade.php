...
@section('content')
<x-section.page-header title="Ubah Informasi / Penilaian SAM Perpipaan PDAM" />

<x-breadcrumb.edit-inspection showRoute="{{ route('perpipaan.show', ['perpipaan' => $form_data['id']]) }}" />

<form action="{{ route('perpipaan.update', ['perpipaan' => $form_data['id']]) }}" method="POST">
    @csrf
    @method('PUT')
    <!-- INFORMASI UMUM -->
            ...
            <div class="grid grid-flow-row md:grid-cols-2 gap-5">
                ...
                <div class="input-group">
                    ...
                    <select id="u006" name="u006" class="select select-bordered w-full" required>
                        <option value="" disabled>Pilih</option>
                        <option value="1" @if($form_data['u006']==1) selected @endif>Ya, dengan cara direbus terlebih dahulu dan digunakan untuk masak</option>
                        <option value="0" @if($form_data['u006']==0) selected @endif>Ya, dan langsung diminum dari keran</option>
                        <option value="-1" @if($form_data['u006']==-1) selected @endif>Tidak digunakan untuk air minum, hanya untuk MCK</option>
                    </select>
                </div>
                @break
                ...
                <div class="input-group">
                    ...
                    <select id="u008" name="u008" class="select select-bordered">
                        <option value="" disabled>Pilih</option>
                ...
                <div class="input-group">
                    ...
                    <select id="u010" name="u010" class="select select-bordered">
                        <option value="" disabled>Pilih</option>
            ...
            <div class="bg-white flex-grow pb-4 rounded-xl">
                ...
                <div class="px-6 sm:px-8">
                    <select id="int012-select" class="select select-bordered w-full" required>
                        <option value="" disabled>Pilih</option>
                        <option value="Hanya menggunakan PDAM" @if($form_data['int012']=='Hanya menggunakan PDAM' ) selected @endif>Hanya menggunakan PDAM</option>
                        <option value="Menggunakan air tanah dengan sumur Bor" @if($form_data['int012']=='Menggunakan air tanah dengan sumur Bor' ) selected @endif>Menggunakan air tanah dengan sumur Bor</option>
                        <option value="Menggunakan air tanah dengan sumur gali terlindungi" @if($form_data['int012']=='Menggunakan air tanah dengan sumur gali terlindungi' ) selected @endif>Menggunakan air tanah dengan sumur gali terlindungi</option>
                        <option value="Other" @if($form_data['int012']!='Hanya menggunakan PDAM' && $form_data['int012']!='Menggunakan air tanah dengan sumur gali terlindungi' && $form_data['int012']!='Menggunakan air tanah dengan sumur Bor' ) selected @endif>Yang Lainnya</option>
                    </select>
                    <input type="text" id="int012" name="int012" placeholder="Ketikan Sumber Air" class="@if($form_data['int012']=='Hanya menggunakan PDAM' || $form_data['int012']=='Menggunakan air tanah dengan sumur gali terlindungi' || $form_data['int012']=='Menggunakan air tanah dengan sumur Bor' ) hidden @endif input input-bordered w-full mt-1" required value="{{ $form_data['int012'] }}" />
                </div>
...
<div data-window-var="perpipaanEditData" data-kecamatan="{{ $form_data['kecamatan'] }}" data-kelurahan="{{ $form_data['kelurahan'] }}" style="display:none;"></div>
...
<script src="{{ asset('js/inspection/sam/perpipaan/edit.js') }}"></script>
