...
@section('content')
<x-section.page-header title="Inspeksi / Penilaian SAM Sumur Bor dengan Pompa Tangan" />

<x-breadcrumb.create-inspection />

<form action="{{ route('sumur-bor-pompa.store') }}" method="POST">
    @csrf
    @method('POST')
    <!-- INFORMASI UMUM -->
        ...
        <div class="bg-white p-6 sm:p-8 rounded-xl">
            ...
            <div class="grid grid-flow-row md:grid-cols-2 gap-5">
                ...
                <div class="input-group">
                    ...
                    <select id="u009" name="u009" class="select select-bordered" required>
                        <option value="" disabled selected>Pilih</option>
                ...
                <div class="input-group">
                    ...
                    <select id="u010a" name="u010a" class="hidden select select-bordered">
...
<script src="{{ asset('js/inspection/sam/sumur-bor-pompa/create.js') }}"></script>
