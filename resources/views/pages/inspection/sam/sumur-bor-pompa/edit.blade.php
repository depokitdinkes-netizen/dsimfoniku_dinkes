...
@section('content')
<x-section.page-header title="Ubah Informasi / Penilaian SAM Sumur Bor dengan Pompa Tangan" />

<x-breadcrumb.edit-inspection showRoute="{{ route('sumur-bor-pompa.show', ['sumur_bor_pompa' => $form_data['id']]) }}" />

<form action="{{ route('sumur-bor-pompa.update', ['sumur_bor_pompa' => $form_data['id']]) }}" method="POST">
    @csrf
    @method('PUT')
    <!-- INFORMASI UMUM -->
            ...
            <div class="grid grid-flow-row md:grid-cols-2 gap-5">
                ...
                <div class="input-group">
                    ...
                    <select id="u006" name="u006" class="select select-bordered" required>
                        <option value="" disabled>Pilih</option>
                        <option value="0-15" @if($form_data['u006']=='0-15' ) selected @endif>0 - 15 Celcius</option>
                        <option value="15-30" @if($form_data['u006']=='15-30' ) selected @endif>15 - 30 Celcius</option>
                        <option value=">30" @if($form_data['u006']=='>30' ) selected @endif>> 30 Celcius</option>
                    </select>
                </div>
                @break
                ...
                <div class="input-group">
                    ...
                    <select id="u007" name="u007" class="select select-bordered" required>
                        <option value="" disabled>Pilih</option>
                        <option value="HUJAN_LEBAT" @if($form_data['u007']=='HUJAN_LEBAT' ) selected @endif>Hujan Lebat</option>
                        <option value="HUJAN" @if($form_data['u007']=='HUJAN' ) selected @endif>Hujan</option>
                        <option value="PANAS" @if($form_data['u007']=='PANAS' ) selected @endif>Panas</option>
                    </select>
                </div>
                @break
                ...
                <div class="input-group">
                    ...
                    <select id="u009" name="u009" class="select select-bordered">
                        <option value="" disabled>Pilih</option>
                        <option value="1" @if($form_data['u009']==1) selected @endif>Ya</option>
                        <option value="0" @if($form_data['u009']==0) selected @endif>Tidak</option>
                ...
                <div class="input-group">
                    ...
                    <select id="u010a" name="u010a" class="@if($form_data['u010']==1) hidden @endif select select-bordered">
                        <option value="" disabled selected>Sebutkan Alasan</option>
                        <option value="BANJIR" @if($form_data['u010a']=='BANJIR' ) selected @endif>Banjir</option>
                        <option value="KEMARAU" @if($form_data['u010a']=='KEMARAU' ) selected @endif>Kemarau</option>
                        <option value="LISTRIK_PADAM" @if($form_data['u010a']=='LISTRIK_PADAM' ) selected @endif>Listrik Padam</option>
