// Sumur Gali Edit Form JavaScript
...
$(document).ready(function() {
    ...
    let kecVal = window.sumurGaliEditData ? window.sumurGaliEditData.kecamatan : "";
    let kelVal = window.sumurGaliEditData ? window.sumurGaliEditData.kelurahan : "";
