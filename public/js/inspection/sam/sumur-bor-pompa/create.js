...
$(document).ready(function() {
    ...
    // Handle u009a select change
    $('#u009a-select').change(function() {
        if (this.value == 1) {
    ...
    // Handle u010a select change
    $('#u010a-select').change(function() {
        if (this.value == 1) {
    ...
    // Handle ins001 radio button change for ket-pengolahan
...
// Calculate SLHS expire date (3 years from issued date)
function calculateSlhsExpireDate() {
    const issuedDateInput = document.getElementById('slhs_issued_date');
    const expireDateInput = document.getElementById('slhs_expire_date');
