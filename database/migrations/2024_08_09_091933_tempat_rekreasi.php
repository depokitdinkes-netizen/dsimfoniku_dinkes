...
return new class extends Migration {
    ...
    public function up(): void {
        Schema::create('tempat_rekreasi', function (Blueprint $table) {
            $table->id();
            $table->string('subjek');
            ...
            $table->enum('uk002', [0, 5]);
            $table->enum('uk003', [0, 5]);
            $table->enum('uk004', [0, 2]);
            $table->enum('uk005', [0, 3]);
    ...
    public function down(): void {
        Schema::dropIfExists('tempat_rekreasi');
    }
};
