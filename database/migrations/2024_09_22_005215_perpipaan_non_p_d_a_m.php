...
return new class extends Migration {
    ...
    public function up(): void {
        Schema::create('perpipaan_non_pdam', function (Blueprint $table) {
            $table->id();
            $table->string('subjek');
            ...
            $table->string('kontak');
            $table->string('sk-pengelola')->nullable();
    ...
    public function down(): void {
        Schema::dropIfExists('perpipaan_non_pdam');
    }
};
